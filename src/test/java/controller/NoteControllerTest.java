...
public class NoteControllerTest {
    ...
    public void testGetByUserId() throws Exception {
        MvcResult mvcResult = mvc.perform(get("/noteDtos/0"))
    ...
    public void testGetByUserAndTagId() throws Exception {
        MvcResult mvcResult = mvc.perform(get("/noteDtos/0/tag/0"))
                .andExpect(status().isOk())
                .andReturn();
        String contentAsString = mvcResult.getResponse()
                .getContentAsString();
    ...
    public void testGetTestByUserAndNotebookId() throws Exception {
        MvcResult mvcResult = mvc.perform(get("/noteDtos/0/0"))
                .andExpect(status().isOk())
                .andReturn();
        String contentAsString = mvcResult.getResponse()
                .getContentAsString();
    ...
    public void testGetTestByUserAndNotebookAndNoteId() throws Exception {
        MvcResult mvcResult = mvc.perform(get("/noteDtos/0/0/0"))
                .andExpect(status().isOk())
                .andReturn();
        String contentAsString = mvcResult.getResponse()
                .getContentAsString();
    ...
    public void testGetTestByUserAndNotebookAndTagId() throws Exception {
        MvcResult mvcResult = mvc.perform(get("/noteDtos/0/0/tag/0"))
                .andExpect(status().isOk())
                .andReturn();
        String contentAsString = mvcResult.getResponse()
                .getContentAsString();
    ...
    public void testDelete() throws Exception {
        mvc.perform(delete("/noteDtos/0/0/0"))
                .andExpect(status().isOk());
    }
}